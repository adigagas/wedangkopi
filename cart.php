<?php
    ...
    //     echo "<script>alert('Silahakan belanja terlebih dahulu')</script>";
				...
				<div class="row row-pb-md">
					<div class="col-md-10 col-md-offset-1">
						...
						<div class="product-cart">
							<div class="one-forth">
								<div class="product-img" style="background-image: url(uploads/produk/<?= $cartproduk['gambar'];?>);">
								</div>
								<div class="display-tc">
									<h3><?= $cartproduk['nama_produk']." ".$cartproduk['nama_opsi']; ?></h3>
								</div>
							</div>
							<div class="one-eight text-center">
								<div class="display-tc">
									<span class="price">Rp. <?= number_format($cartproduk['harga']); ?></span>
								</div>
							</div>
							<div class="one-eight text-center">
								<div class="display-tc">
									<input type="text" id="quantity" name="quantity" class="form-control input-number text-center" value="<?= $jumlah; ?>" min="1" max="100">
								</div>
							</div>
							<div class="one-eight text-center">
								<div class="display-tc">
									<span class="price">Rp. <?= number_format($subtotal); ?></span>
								</div>
							</div>
							<div class="one-eight text-center">
								<div class="display-tc">
									<a href="functions/hapusitem.php?id=<?= $id_produk; ?>" class="closed"></a>
								</div>
							</div>
						</div>
						<?php $totalberat += $subberat; ?>
						<?php $totalbelanja = $totalbelanja+$subtotal; ?>
						<?php endforeach; ?>
								...
								<div class="col-md-3 col-md-push-9 text-center">
									<div class="total">
										<div class="grand-total">
											<p><span><strong>Total Belanja:</strong></span> <span>Rp. <?= number_format($totalbelanja);?></span></p>
											<p><span><strong>Total Berat:</strong></span> <span><?= number_format($totalberat);?>gr</span></p>
											<a href="pengiriman.php" class="btn btn-warning btn-addtocart">Checkout</a>
										</div>
									</div>
								</div>
							</div>
