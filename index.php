<?php
	...
	$tampilkanproduk = mysqli_query($conn, "SELECT produk.id_produk, produk.nama_produk, produk.id_jenis, produk.id_opsi, jenis_produk.nama_jenis, opsi.nama_opsi, produk.harga, produk.deskripsi, produk.gambar, produk.stok
	FROM produk, jenis_produk, opsi
	WHERE produk.id_jenis = jenis_produk.id_jenis AND produk.id_opsi = opsi.id_opsi ORDER BY id_produk DESC LIMIT 4");
...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="page">
		...
		<div class="fluid-container my-5 bg-white">
			<div class="row mt-5 justify-content-center">
				<div class="col-md-9  mt-5">
					<h3 class="text-warning">Produk</h3>
				</div>
			</div>
			<div class="row mx-5 justify-content-center">
				<?php while($dataproduk = mysqli_fetch_assoc($tampilkanproduk)): ?>
					<div class="col-md-2 mb-5">
						<div class="card">
							<img class="card-img-top" src="uploads/produk/<?= $dataproduk['gambar']; ?>" width="100%" alt="Card image cap">
							<div class="card-body text-center">
								<h4><?= $dataproduk['nama_produk']." ".$dataproduk['nama_opsi']; ?></h4>
								<p class="text-warning"><strong>Rp. <?= number_format($dataproduk['harga']); ?></strong></p>
								<br>
								<a href="detail-produk.php?id=<?= $dataproduk['id_produk']; ?>"><button class="btn btn-warning text-light">Beli</button></a>
							</div>
						</div>
					</div>
				<?php endwhile; ?>
				
				<div class="card text-white bg-warning mb-5" style="max-width: 20rem;">
					<div class="card-body text-center">
						
						<p class="card-text">Untuk melihat lebih banyak produk silahkan tekan tombol lanjut</p>
						<a href="produk.php"><button class="btn btn-light text-warning">Lebih</button></a>
					</div>
				</div>
			</div>
			<hr>
			<div class="row mt-5 justify-content-center">
				<div class="col-md-9  mt-5">
					<h3 class="text-warning">Mechandise</h3>
				</div>
			</div>
			<div class="row mx-5 justify-content-center">
				<?php while($dataproduk = mysqli_fetch_assoc($tampilkanproduk)): ?>
