<?php
	...
	$tampilkanproduk = mysqli_query($conn, "SELECT produk.id_produk, produk.nama_produk, jenis_produk.nama_jenis, opsi.nama_opsi, produk.harga, produk.deskripsi, produk.gambar, produk.stok
	...
	<div id="page">
		...
		<div class="fluid-container bg-white">
			<div class="row justify-content center my-5">
				<div class="col-md-5">
					<h2>Masukkan KODE PEMBAYARAN</h2>
